...
void ContentObjectHeader::Corrupt()
{
	m_signType = 5; //Tipo de assinatura não existente
}

bool ContentObjectHeader::IsCorrupted() const
{
	return m_signType;
}
